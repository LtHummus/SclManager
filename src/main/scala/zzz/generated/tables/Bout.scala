...
class Bout(alias : String, aliased : Table[BoutRecord], parameters : Array[ Field[_] ]) extends TableImpl[BoutRecord](alias, Scl.SCL, aliased, parameters, "") {
   ...
   */
  val WINNER : TableField[BoutRecord, String] = createField("winner", org.jooq.impl.SQLDataType.VARCHAR.length(50).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.VARCHAR)), "")

  /**
   * The column <code>scl.bout.match_url</code>.
   */
  val MATCH_URL : TableField[BoutRecord, String] = createField("match_url", org.jooq.impl.SQLDataType.CLOB.nullable(false), "")
