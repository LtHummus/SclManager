...
class MatchRecord extends UpdatableRecordImpl[MatchRecord](Match.MATCH) with Record8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, String] {
  ...
  /**
   * Setter for <code>scl.match.winner</code>.
   */
  def setWinner(value : Integer) : Unit = {
    set(6, value)
  }

  /**
   * Getter for <code>scl.match.winner</code>.
   */
  def getWinner : Integer = {
    val r = get(6)
    if (r == null) null else r.asInstanceOf[Integer]
  }

  /**
   * Setter for <code>scl.match.match_url</code>.
   */
  ...
  /**
   * Getter for <code>scl.match.match_url</code>.
   */
  ...
  override def fieldsRow : Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, String] = {
    super.fieldsRow.asInstanceOf[ Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, String] ]
  }

  override def valuesRow : Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, String] = {
    super.valuesRow.asInstanceOf[ Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, String] ]
  }
  ...
  override def field7 : Field[Integer] = Match.MATCH.WINNER
  override def field8 : Field[String] = Match.MATCH.MATCH_URL
  ...
  override def value7 : Integer = getWinner
  ...
  override def value7(value : Integer) : MatchRecord = {
    setWinner(value)
    this
  }

  override def value8(value : String) : MatchRecord = {
    setMatchUrl(value)
    this
  }

  override def values(value1 : Integer, value2 : Integer, value3 : Integer, value4 : Integer, value5 : Integer, value6 : Integer, value7 : Integer, value8 : String) : MatchRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, week : Integer, league : Integer, player1 : Integer, player2 : Integer, status : Integer, winner : Integer, matchUrl : String) = {
    this()
