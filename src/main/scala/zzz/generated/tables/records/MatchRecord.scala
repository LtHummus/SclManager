...
class MatchRecord extends UpdatableRecordImpl[MatchRecord](Match.MATCH) with Record7[Integer, Integer, Integer, Integer, Integer, Integer, Integer] {
  ...
  override def values(value1 : Integer, value2 : Integer, value3 : Integer, value4 : Integer, value5 : Integer, value6 : Integer, value7 : Integer) : MatchRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, week : Integer, league : Integer, player1 : Integer, player2 : Integer, status : Integer, winner : Integer) = {
    this()
