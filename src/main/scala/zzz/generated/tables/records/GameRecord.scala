...
class GameRecord extends UpdatableRecordImpl[GameRecord](Game.GAME) with Record8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer] {
   ...
   */
  def setLevel(value : Integer) : Unit = {
    set(6, value)
  }
   ...
   */
  def setGametype(value : Integer) : Unit = {
    set(7, value)
  }
  ...
  override def fieldsRow : Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer] = {
    super.fieldsRow.asInstanceOf[ Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer] ]
  }

  override def valuesRow : Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer] = {
    super.valuesRow.asInstanceOf[ Row8[Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer] ]
  }
  ...
  override def field7 : Field[Integer] = Game.GAME.LEVEL
  override def field8 : Field[Integer] = Game.GAME.GAMETYPE
  ...
  override def value7 : Integer = getLevel
  override def value8 : Integer = getGametype
  ...
  override def value7(value : Integer) : GameRecord = {
    setLevel(value)
    this
  }

  override def value8(value : Integer) : GameRecord = {
    setGametype(value)
    this
  }

  override def values(value1 : Integer, value2 : Integer, value3 : Integer, value4 : Integer, value5 : Integer, value6 : Integer, value7 : Integer, value8 : Integer) : GameRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, spy : Integer, sniper : Integer, `match` : Integer, result : Integer, sequence : Integer, level : Integer, gametype : Integer) = {
    this()
