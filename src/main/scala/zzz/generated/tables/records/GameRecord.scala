...
class GameRecord extends UpdatableRecordImpl[GameRecord](Game.GAME) with Record9[Integer, String, String, Integer, Integer, Integer, String, String, String] {
  ...
  override def fieldsRow : Row9[Integer, String, String, Integer, Integer, Integer, String, String, String] = {
    super.fieldsRow.asInstanceOf[ Row9[Integer, String, String, Integer, Integer, Integer, String, String, String] ]
  }

  override def valuesRow : Row9[Integer, String, String, Integer, Integer, Integer, String, String, String] = {
    super.valuesRow.asInstanceOf[ Row9[Integer, String, String, Integer, Integer, Integer, String, String, String] ]
  }
  ...
  override def values(value1 : Integer, value2 : String, value3 : String, value4 : Integer, value5 : Integer, value6 : Integer, value7 : String, value8 : String, value9 : String) : GameRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, spy : String, sniper : String, bout : Integer, result : Integer, sequence : Integer, venue : String, gametype : String, uuid : String) = {
    this()
