...
class GameRecord extends UpdatableRecordImpl[GameRecord](Game.GAME) with Record10[Integer, String, String, Integer, Integer, Integer, String, String, String, Timestamp] {
  ...
  override def fieldsRow : Row10[Integer, String, String, Integer, Integer, Integer, String, String, String, Timestamp] = {
    super.fieldsRow.asInstanceOf[ Row10[Integer, String, String, Integer, Integer, Integer, String, String, String, Timestamp] ]
  }

  override def valuesRow : Row10[Integer, String, String, Integer, Integer, Integer, String, String, String, Timestamp] = {
    super.valuesRow.asInstanceOf[ Row10[Integer, String, String, Integer, Integer, Integer, String, String, String, Timestamp] ]
  }
  ...
  override def field9 : Field[String] = Game.GAME.UUID
  override def field10 : Field[Timestamp] = Game.GAME.TIMESTAMP
  ...
  override def value9 : String = getUuid
  override def value10 : Timestamp = getTimestamp
  ...
  override def value9(value : String) : GameRecord = {
    setUuid(value)
    this
  }

  override def value10(value : Timestamp) : GameRecord = {
    setTimestamp(value)
    this
  }

  override def values(value1 : Integer, value2 : String, value3 : String, value4 : Integer, value5 : Integer, value6 : Integer, value7 : String, value8 : String, value9 : String, value10 : Timestamp) : GameRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, spy : String, sniper : String, bout : Integer, result : Integer, sequence : Integer, venue : String, gametype : String, uuid : String, timestamp : Timestamp) = {
    this()
