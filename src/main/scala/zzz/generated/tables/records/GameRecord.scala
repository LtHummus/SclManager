...
class GameRecord extends UpdatableRecordImpl[GameRecord](Game.GAME) with Record13[Integer, String, String, Integer, Integer, Integer, String, String, Integer, Integer, String, Timestamp, Integer] {
  ...
  /**
   * Setter for <code>scl.game.missions_completed</code>.
   */
  def setMissionsCompleted(value : Integer) : Unit = {
    set(12, value)
  }

  /**
   * Getter for <code>scl.game.missions_completed</code>.
   */
  def getMissionsCompleted : Integer = {
    val r = get(12)
    if (r == null) null else r.asInstanceOf[Integer]
  }
  ...
  override def fieldsRow : Row13[Integer, String, String, Integer, Integer, Integer, String, String, Integer, Integer, String, Timestamp, Integer] = {
    super.fieldsRow.asInstanceOf[ Row13[Integer, String, String, Integer, Integer, Integer, String, String, Integer, Integer, String, Timestamp, Integer] ]
  }

  override def valuesRow : Row13[Integer, String, String, Integer, Integer, Integer, String, String, Integer, Integer, String, Timestamp, Integer] = {
    super.valuesRow.asInstanceOf[ Row13[Integer, String, String, Integer, Integer, Integer, String, String, Integer, Integer, String, Timestamp, Integer] ]
  }
  ...
  override def field13 : Field[Integer] = Game.GAME.MISSIONS_COMPLETED
  ...
  override def component13 : Integer = getMissionsCompleted
  ...
  override def value13 : Integer = getMissionsCompleted
  ...
  override def value13(value : Integer) : GameRecord = {
    setMissionsCompleted(value)
    this
  }

  override def values(value1 : Integer, value2 : String, value3 : String, value4 : Integer, value5 : Integer, value6 : Integer, value7 : String, value8 : String, value9 : Integer, value10 : Integer, value11 : String, value12 : Timestamp, value13 : Integer) : GameRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, spy : String, sniper : String, bout : Integer, result : Integer, sequence : Integer, venue : String, gametype : String, startDurationSeconds : Integer, guests : Integer, uuid : String, timestamp : Timestamp, missionsCompleted : Integer) = {
    this()
