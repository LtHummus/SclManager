...
class BoutRecord extends UpdatableRecordImpl[BoutRecord](Bout.BOUT) with Record8[Integer, Integer, String, String, String, Integer, String, String] {
  ...
  override def fieldsRow : Row8[Integer, Integer, String, String, String, Integer, String, String] = {
    super.fieldsRow.asInstanceOf[ Row8[Integer, Integer, String, String, String, Integer, String, String] ]
  }

  override def valuesRow : Row8[Integer, Integer, String, String, String, Integer, String, String] = {
    super.valuesRow.asInstanceOf[ Row8[Integer, Integer, String, String, String, Integer, String, String] ]
  }
  ...
  override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : Integer, value7 : String, value8 : String) : BoutRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, week : Integer, division : String, player1 : String, player2 : String, status : Integer, winner : String, matchUrl : String) = {
    this()
