...
class BoutRecord extends UpdatableRecordImpl[BoutRecord](Bout.BOUT) with Record10[Integer, Integer, String, String, String, Integer, String, String, Integer, Integer] {
  ...
  override def fieldsRow : Row10[Integer, Integer, String, String, String, Integer, String, String, Integer, Integer] = {
    super.fieldsRow.asInstanceOf[ Row10[Integer, Integer, String, String, String, Integer, String, String, Integer, Integer] ]
  }

  override def valuesRow : Row10[Integer, Integer, String, String, String, Integer, String, String, Integer, Integer] = {
    super.valuesRow.asInstanceOf[ Row10[Integer, Integer, String, String, String, Integer, String, String, Integer, Integer] ]
  }
  ...
  override def values(value1 : Integer, value2 : Integer, value3 : String, value4 : String, value5 : String, value6 : Integer, value7 : String, value8 : String, value9 : Integer, value10 : Integer) : BoutRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, week : Integer, division : String, player1 : String, player2 : String, status : Integer, winner : String, matchUrl : String, draft : Integer, boutType : Integer) = {
    this()
