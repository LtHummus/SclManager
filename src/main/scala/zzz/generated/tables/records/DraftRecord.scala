...
class DraftRecord extends UpdatableRecordImpl[DraftRecord](Draft.DRAFT) with Record6[Integer, String, String, String, Timestamp, String] {
  ...
  override def component2 : String = getRoomCode
  override def component3 : String = getPlayer1
  override def component4 : String = getPlayer2
  override def component5 : Timestamp = getTime
  override def component6 : String = getPayload
