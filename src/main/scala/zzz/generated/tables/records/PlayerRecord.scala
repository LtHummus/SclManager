...
class PlayerRecord extends UpdatableRecordImpl[PlayerRecord](Player.PLAYER) with Record9[String, String, String, Integer, Integer, Integer, String, Byte, Byte] {
  ...
  override def component2 : String = getReplayName
  override def component3 : String = getDivision
  override def component4 : Integer = getWins
  override def component5 : Integer = getDraws
  override def component6 : Integer = getLosses
  override def component7 : String = getCountry
  override def component8 : Byte = getParticipating
  override def component9 : Byte = getActive
