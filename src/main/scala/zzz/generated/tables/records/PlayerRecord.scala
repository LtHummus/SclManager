...
class PlayerRecord extends UpdatableRecordImpl[PlayerRecord](Player.PLAYER) with Record6[Integer, String, Integer, Integer, Integer, Integer] {
  ...
  override def fieldsRow : Row6[Integer, String, Integer, Integer, Integer, Integer] = {
    super.fieldsRow.asInstanceOf[ Row6[Integer, String, Integer, Integer, Integer, Integer] ]
  }

  override def valuesRow : Row6[Integer, String, Integer, Integer, Integer, Integer] = {
    super.valuesRow.asInstanceOf[ Row6[Integer, String, Integer, Integer, Integer, Integer] ]
  }
  ...
  override def values(value1 : Integer, value2 : String, value3 : Integer, value4 : Integer, value5 : Integer, value6 : Integer) : PlayerRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(id : Integer, name : String, league : Integer, wins : Integer, draws : Integer, losses : Integer) = {
    this()
