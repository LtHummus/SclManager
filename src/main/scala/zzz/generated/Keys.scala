...
object Keys {
  ...
  private object ForeignKeys0 extends AbstractKeys {
    ...
    val FK_MATCH : ForeignKey[GameRecord, PlayerRecord] = AbstractKeys.createForeignKey(zzz.generated.Keys.KEY_PLAYER_PRIMARY, Game.GAME, "fk_match", Game.GAME.MATCH)
